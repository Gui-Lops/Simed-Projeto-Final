...
import os
# ou from decouple import config
...
SECRET_KEY = 'django-insecure-uzxs-$dzownxikjan$bsg86e&5s^n0(jfw%!r6kd@#g#js0gtf'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sistema_consultas',   # nome do banco
        'USER': 'root',                # usuário do banco
        'PASSWORD': 'Gerc1943',  # senha do root
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # opcional, se tiver uma pasta static global
]
